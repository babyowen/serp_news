...
SEARCH_KEYWORDS = {
    ...
    "公积金": ["公积金"],
    "政府基金": ["政府基金", "引导基金","母基金"],
    "江苏省国资委": ["江苏省国资委", "南京市国资委","江苏国信集团","江苏交通控股","东部机场","苏豪","中江集团","江苏农垦","徐矿集团","江苏沿海集团","江苏港口集团","江苏铁路集团","江苏环保集团","江苏盐业集团","江苏粮食集团","江苏省高投","金陵饭店","钟山宾馆","江苏水源","江苏体育集团","江苏国金集团","江苏规划设计集团","江苏省数据集团"],
...
- 结构与前两轮一致，包含：
  - ## **[NEWS] 今日综述**
  - ## **[SUMMARY] 新闻总结**(其中持续出现的新闻请用类似(该新闻近期频繁被提及)来做一些提示，但无需过分描述)
  - ## **[OPINION] 观点总结**
